...
public class Excel {
	...
	public static ArrayList<String> getData(String testcase, String parameter) throws IOException {
		...
		FileInputStream fis = new FileInputStream("C:\\Users\\91933\\excelhybrid1.xlsx");
